...
from services.external import hf_driver, openai_driver
from services.data_models import Chat, ChatMessage, MessageRole, Model, DatasetRow
from services import config
from services.finetuning.data_models import FTJob, OpenAIFTJob, UnslothFinetuningJob
...
async def _run_unsloth_finetuning_job(
    ...
    logger.info(f"Dataset examples: {ft_dataset[:5]}")
    ...
    return Model(id=id, type="open_source", parent_model=job.source_model.model_dump())
